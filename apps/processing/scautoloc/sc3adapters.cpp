...
/* TEMP OBSOLETE?
		...
		if ( !scpick ) {
			...
			if ( arr.pick->mode == Autoloc::Pick::Manual ) {
				scpick->setEvaluationMode(Seiscomp::DataModel::EvaluationMode(Seiscomp::DataModel::MANUAL));
			}
			else {
